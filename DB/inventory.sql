...
INSERT INTO `companies` (`id`, `name`, `phone`, `address`, `created_at`, `updated_at`) VALUES
	(1, 'Inventarios Domingito', '+591 65803513', 'Av. Los Sauces, esq. Fabián Ruiz, Zona German Busch, Tarija, Bolivia, Código Postal 01230.', NULL, '2023-04-17 05:35:09');
...
INSERT INTO `customers` (`id`, `customer_name`, `email`, `phone`, `address`, `status`, `created_at`, `updated_at`) VALUES
	(37, 'Juan Pérez', 'juan.perez@example.com', '555-1234', 'Calle Ingavi 101, Zona Central, Tarija, Bolivia', 1, '2023-04-17 02:08:05', '2023-04-17 02:08:05'),
	(38, 'María Rodríguez', 'maria.rodriguez@example.com', '555-5678', 'Av. La Banda 102, Zona San Roque, Tarija, Bolivia', 1, '2023-04-17 02:08:05', '2023-04-17 02:08:05'),
	(39, 'Pedro García', 'pedro.garcia@example.com', '555-9876', 'Calle Bolívar 103, Zona Lourdes, Tarija, Bolivia', 1, '2023-04-17 02:08:05', '2023-04-17 02:08:05'),
	(40, 'Ana Hernández', 'ana.hernandez@example.com', '555-2468', 'Calle Sucre 104, Zona La Loma, Tarija, Bolivia', 1, '2023-04-17 02:08:05', '2023-04-17 04:36:26'),
	(41, 'Jorge Martínez', 'jorge.martinez@example.com', '555-3691', 'Av. Víctor Paz Estenssoro 105, Zona Central, Tarija, Bolivia', 1, '2023-04-17 02:08:05', '2023-04-17 02:08:05'),
	(42, 'Laura González', 'laura.gonzalez@example.com', '555-5555', 'Av. Circunvalación 106, Zona Senac, Tarija, Bolivia', 1, '2023-04-17 02:08:05', '2023-04-17 02:08:05'),
	(43, 'Miguel Álvarez', 'miguel.alvarez@example.com', '555-7777', 'Calle Cochabamba 107, Zona Tabladita, Tarija, Bolivia', 1, '2023-04-17 02:08:05', '2023-04-17 02:08:05'),
	(44, 'Carmen Flores', 'carmen.flores@example.com', '555-1212', 'Calle Oruro 108, Zona El Molino, Tarija, Bolivia', 1, '2023-04-17 02:08:05', '2023-04-17 02:08:05'),
	(45, 'José García', 'jose.garcia@example.com', '555-7777', 'Calle Junín 109, Zona San Bernardo, Tarija, Bolivia', 1, '2023-04-17 02:08:05', '2023-04-17 02:08:05'),
	(46, 'Fernanda González', 'fernanda.gonzalez@example.com', '555-2345', 'Calle Campero 110, Zona Tomatitas, Tarija, Bolivia', 1, '2023-04-17 02:08:05', '2023-04-17 02:08:05'),
	(47, 'Diego Torres', 'diego.torres@example.com', '555-4567', 'Calle Ingavi 111, Zona Central, Tarija, Bolivia', 1, '2023-04-17 02:08:05', '2023-04-17 02:08:05'),
	(48, 'Carla Hernández', 'carla.hernandez@example.com', '555-1111', 'Calle Bolívar 112, Zona Lourdes, Tarija, Bolivia', 1, '2023-04-17 02:08:05', '2023-04-17 02:08:05'),
	(49, 'Raúl Díaz', 'raul.diaz@example.com', '555-2222', 'Av. La Banda 113, Zona San Roque, Tarija, Bolivia', 1, '2023-04-17 02:08:05', '2023-04-17 02:08:05'),
	(50, 'Sofía García', 'sofia.garcia@example.com', '555-3333', 'Calle Sucre 114, Zona La Loma, Tarija, Bolivia', 1, '2023-04-17 02:08:05', '2023-04-17 02:08:05'),
	(51, 'Héctor Jiménez', 'hector.jimenez@example.com', '555-4444', 'Av. Víctor Paz Estenssoro 115, Zona Central, Tarija, Bolivia', 1, '2023-04-17 02:08:05', '2023-04-17 02:08:05'),
	(52, 'Diana Martínez', 'diana.martinez@example.com', '555-5555', 'Av. Circunvalación 116, Zona Senac, Tarija, Bolivia', 1, '2023-04-17 02:08:05', '2023-04-17 02:08:05');
...
INSERT INTO `users` (`id`, `name`, `email`, `password`, `branch_id`, `role_id`, `remember_token`, `created_at`, `updated_at`) VALUES
	(12, 'Reynaldo Leonel Burgos Ramirez', 'leodurgo86@gmail.com', '$2y$10$W/nqTuN0X.JaGtGBkpw01OTSL0I3aShYL9QusP8Q5kIZ2AviqQHKC', 1, 2, '6zd4CxMA9RCTnuJaxtyhByrBYJsPfV9GtAB4pJE3Ht6YTsIvQ7ETjUVO1jlv', '2020-07-31 17:27:25', '2023-04-17 05:20:18');
...
INSERT INTO `vendors` (`id`, `name`, `phone`, `email`, `address`, `created_at`, `updated_at`) VALUES
	(76, 'La Michoacana', '55-1234-5678', 'contacto@lamichoacana.com', 'Calle Ingavi 123, Zona Central, Tarija, Bolivia', '2023-04-16 21:44:30', '2023-04-16 21:44:30'),
	(77, 'El Paraiso del Helado', '55-8765-4321', 'info@elparaisodelhelado.com', 'Av. La Banda 456, Zona San Roque, Tarija, Bolivia', '2023-04-16 21:44:30', '2023-04-16 21:44:30'),
	(78, 'La Flor de Michoacán', '33-3333-3333', 'ventas@laflordemichoacan.com', 'Calle Bolívar 789, Zona Lourdes, Tarija, Bolivia', '2023-04-16 21:44:30', '2023-04-16 21:44:30'),
	(79, 'Paletería la Victoria', '81-1111-1111', 'contacto@paleterialavictoria.com', 'Av. Víctor Paz Estenssoro 101, Zona Central, Tarija, Bolivia', '2023-04-16 21:44:30', '2023-04-16 21:44:30'),
	(80, 'Helados Santa Clara', '55-5555-5555', 'contacto@santaclara.com', 'Av. Circunvalación 202, Zona Senac, Tarija, Bolivia', '2023-04-16 21:44:30', '2023-04-16 21:44:30'),
	(81, 'La Imperial', '33-2222-2222', 'info@laimperial.com', 'Calle Sucre 303, Zona La Loma, Tarija, Bolivia', '2023-04-16 21:44:30', '2023-04-16 21:44:30'),
	(82, 'Helados Holanda', '55-9876-5432', 'contacto@heladosholanda.com', 'Calle Cochabamba 404, Zona Tabladita, Tarija, Bolivia', '2023-04-16 21:44:30', '2023-04-16 21:44:30'),
	(83, 'Nieve Garrafa', '55-1111-2222', 'ventas@nievegarrafa.com', 'Calle Oruro 505, Zona El Molino, Tarija, Bolivia', '2023-04-16 21:44:30', '2023-04-16 21:44:30'),
	(84, 'La Tapatía Helados', '33-4444-4444', 'contacto@latapatiahelados.com', 'Calle Junín 606, Zona San Bernardo, Tarija, Bolivia', '2023-04-16 21:44:30', '2023-04-16 21:44:30'),
	(85, 'La Tradicional', '81-2222-2222', 'info@latradicional.com', 'Calle Campero 707, Zona Tomatitas, Tarija, Bolivia', '2023-04-16 21:44:30', '2023-04-16 21:44:30');
